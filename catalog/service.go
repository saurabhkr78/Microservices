...
type Service interface {
	PostProuct(ctx context.Context, name string, description string, price float64) (*Product, error)
...
func (s *catalogService) PostProuct(ctx context.Context, name string, description string, price float64) (*Product, error) {
	p := &Product{
		ID:          ksuid.New().String(),
		Name:        name,
