...
import (
	"context"
	"fmt"
	"github.com/saurabh/Microservices/account/pb"
	"net"
...
func ListenGRPC(s Service, port int) error {
	...
	srv := grpc.NewServer()
	pb.RegisterAccountServiceServer(srv, &grpcServer{UnimplementedAccountServiceServer: pb.UnimplementedAccountServiceServer{}, service: s})
