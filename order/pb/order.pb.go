...
func (x *GetOrderResposne) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetOrderResposne) ProtoMessage() {}

func (x *GetOrderResposne) ProtoReflect() protoreflect.Message {
	mi := &file_order_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetOrderResposne.ProtoReflect.Descriptor instead.
func (*GetOrderResposne) Descriptor() ([]byte, []int) {
	return file_order_proto_rawDescGZIP(), []int{4}
}

func (x *GetOrderResposne) GetOrder() *Order {
	if x != nil {
		return x.Order
	}
	return nil
...
type GetOrdersFromAccountRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *GetOrdersFromAccountRequest) Reset() {
	*x = GetOrdersFromAccountRequest{}
	mi := &file_order_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetOrdersFromAccountRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetOrdersFromAccountRequest) ProtoMessage() {}

func (x *GetOrdersFromAccountRequest) ProtoReflect() protoreflect.Message {
	mi := &file_order_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetOrdersFromAccountRequest.ProtoReflect.Descriptor instead.
func (*GetOrdersFromAccountRequest) Descriptor() ([]byte, []int) {
	return file_order_proto_rawDescGZIP(), []int{5}
}

func (x *GetOrdersFromAccountRequest) GetAccountId() string {
	if x != nil {
		return x.AccountId
	}
	return ""
...
type GetOrdersFromAccountResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *GetOrdersFromAccountResponse) Reset() {
	*x = GetOrdersFromAccountResponse{}
	mi := &file_order_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetOrdersFromAccountResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetOrdersFromAccountResponse) ProtoMessage() {}

func (x *GetOrdersFromAccountResponse) ProtoReflect() protoreflect.Message {
	mi := &file_order_proto_msgTypes[6]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetOrdersFromAccountResponse.ProtoReflect.Descriptor instead.
func (*GetOrdersFromAccountResponse) Descriptor() ([]byte, []int) {
	return file_order_proto_rawDescGZIP(), []int{6}
}

func (x *GetOrdersFromAccountResponse) GetOrders() []*Order {
	if x != nil {
		return x.Orders
	}
	return nil
...
const file_order_proto_rawDesc = "" +
	...
	"\x10GetOrderResposne\x12\x1f\n" +
	"\x05order\x18\x01 \x01(\v2\t.pb.OrderR\x05order\";\n" +
	"\x1bGetOrdersFromAccountRequest\x12\x1c\n" +
	"\taccountId\x18\x01 \x01(\tR\taccountId\"A\n" +
	"\x1cGetOrdersFromAccountResponse\x12!\n" +
	"\x06orders\x18\x01 \x03(\v2\t.pb.OrderR\x06orders2\xda\x01\n" +
	"\fOrderService\x128\n" +
	"\tPostOrder\x12\x14.pb.PostOrderRequest\x1a\x15.pb.PostOrderResponse\x125\n" +
	"\bGetOrder\x12\x13.pb.GetOrderRequest\x1a\x14.pb.GetOrderResposne\x12Y\n" +
	"\x14GetOrdersFromAccount\x12\x1f.pb.GetOrdersFromAccountRequest\x1a .pb.GetOrdersFromAccountResponseB\x04Z\x02./b\x06proto3"
...
var file_order_proto_goTypes = []any{
	...
	(*GetOrderResposne)(nil),              // 4: pb.GetOrderResposne
	(*GetOrdersFromAccountRequest)(nil),   // 5: pb.GetOrdersFromAccountRequest
	(*GetOrdersFromAccountResponse)(nil),  // 6: pb.GetOrdersFromAccountResponse
...
var file_order_proto_depIdxs = []int32{
	...
	0, // 3: pb.GetOrderResposne.order:type_name -> pb.Order
	0, // 4: pb.GetOrdersFromAccountResponse.orders:type_name -> pb.Order
	1, // 5: pb.OrderService.PostOrder:input_type -> pb.PostOrderRequest
	3, // 6: pb.OrderService.GetOrder:input_type -> pb.GetOrderRequest
	5, // 7: pb.OrderService.GetOrdersFromAccount:input_type -> pb.GetOrdersFromAccountRequest
	2, // 8: pb.OrderService.PostOrder:output_type -> pb.PostOrderResponse
	4, // 9: pb.OrderService.GetOrder:output_type -> pb.GetOrderResposne
	6, // 10: pb.OrderService.GetOrdersFromAccount:output_type -> pb.GetOrdersFromAccountResponse
